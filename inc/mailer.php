<?php
	...
	if(isset($_POST['submit'])){
		...
		if(array_filter($errors)){
			...
			// create sql
			$sql = "INSERT INTO formagain (fname,lname,email,subject,message) VALUES('$fname','$lname','$email','$subject','$message')";

			//change fromagain to form
			// save to db and check
			if(mysqli_query($conn, $sql)){
				// success
				// header('Location: index.php'); 
                echo '<span class="confirm" style="color: green; font-size: 24px; display: flex; justify-content: center;"><strong>&#10004; Thank you, your message has been saved!</strong></span>';
			} else {
